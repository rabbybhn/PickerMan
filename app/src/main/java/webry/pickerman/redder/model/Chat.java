...
public class Chat extends Application implements Constants, Parcelable {
    ...
    private long withUserId, fromUserId, toUserId, toItemId = 0;
    private int id, withUserState, newMessagesCount, createAt, withUserVerify;
    private String withUserUsername, withUserFullname, withUserPhotoUrl, timeAgo, date, lastMessage, lastMessageAgo, title = "";
    ...
    public Chat(JSONObject jsonData) {
        ...
        try {
            ...
            if (jsonData.has("itemTitle")) {

                this.setTitle(jsonData.getString("itemTitle"));
            }

            if (jsonData.has("toItemId")) {

                this.setToItemId(jsonData.getLong("toItemId"));
            }
